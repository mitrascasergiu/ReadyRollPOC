...
:setvar DefaultBackupPath "C:\Program Files\Microsoft SQL Server\MSSQL11.SQL2012\MSSQL\Backup\"
----====================================================================================================================
...
IF (@@SERVERNAME != 'V-GNRC-SG01\SQL2012' OR '$(DatabaseName)' != 'i-Balancer')
BEGIN
	RAISERROR(N'This script should only be executed on the following server/instance: [V-GNRC-SG01\SQL2012] (Database: [i-Balancer]). Halting deployment.', 16, 127, N'UNKNOWN') WITH NOWAIT;
	RETURN;
END
GO
